-- 0091: Add description column to challenge_levels
-- and update get_challenge_boards RPC to include it

-- 1. Add description column
alter table public.challenge_levels
  add column if not exists description text;

-- 2. Update get_challenge_boards to include level description
